                ...
                <form action="{{ route('instructor.update', $course -> id) }}" class="comment-form contact-form" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <input type="text" placeholder="sosu-titre du cours" name="subtitle" value="{{ $course -> subtitle }}">
                        </div>
                        <div class="col-lg-12">
                            <label for="description">Description du cours</label>
                            <textarea type="textarea" placeholder="desciption du  cours" name="description">{{ $course -> description }} </textarea>
                        </div>
                        <div class="col-lg-12">
